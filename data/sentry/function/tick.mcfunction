...
execute as @e[scores={size_timer=1..}] run scoreboard players remove @s size_timer 1
execute as @e[scores={size_timer=0}] run function sentry:size_ball/restore_size